...
def test_draft_authors_picks_newest_revision_and_roles(_seeded):
    out = mcp_server.tool_draft_authors("draft-ietf-xtest-foo")
...
def test_draft_authors_accepts_versioned_name(_seeded):
    out = mcp_server.tool_draft_authors("draft-ietf-xtest-foo-01")
...
def test_draft_authors_empty_name():
    assert "Provide a draft name" in mcp_server.tool_draft_authors("")
