...
For an introduction to ietf-llm, see the [main README](../README.md).

## Using ietf-llm

### Over MCP (the common case)

- **[Running the MCP server locally](mcp-local.md)** — over stdio. Setup for local harnesses. *Start here*
